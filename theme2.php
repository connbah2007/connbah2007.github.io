                        ...
                        <div class="alert alert-info text-left">
                            ...
                            <ul>
                                <li style="font-weight: 400;" aria-level="1"><strong>Bước 1:</strong><span
                                        ...
                                        <b><?=$_SERVER['SERVER_NAME'];?></b>, ngay phía dưới logo có các thể loại game <?php
                                ...
                                <li style="font-weight: 400;" aria-level="1"><strong>Bước 3:</strong><span
                                        style="font-weight: 400;"> Sau khi coppy SĐT, ae xem kỹ mã cực tương
        ...
        <div class="container text-center">
            <div class="row">
                <div class="col-xs-12 text-white">
                    Copyright 2023 © <a class="text-white" href="https://t.me/<?=TELE_ADMIN;?>" target="_blank"></a> | All rights reserved
                </div>
            </div>
        </div>
    </footer>
